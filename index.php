...
<link rel="stylesheet" type="text/css" href="./admin/fonts/font-awesome/css/font-awesome.css">
    ...
    ?>
      <div class="col-xs-12 col-sm-4">
        <div class="features-item">
          ...
          <?php 
           $ruta = "admin/vistas/img/productos/".$rowPlatillos["codigo"];
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-xs-6 col-md-3">
        <div class="gallery-item"> <img src="./admin/img/gallery/01.jpg" class="img-responsive" alt=""></div>
      </div>
      <div class="col-xs-6 col-md-3">
        <div class="gallery-item"> <img src="./admin/img/gallery/02.jpg" class="img-responsive" alt=""></div>
      </div>
      <div class="col-xs-6 col-md-3">
        <div class="gallery-item"> <img src="./admin/img/gallery/03.jpg" class="img-responsive" alt=""></div>
      </div>
      <div class="col-xs-6 col-md-3">
        <div class="gallery-item"> <img src="./admin/img/gallery/04.jpg" class="img-responsive" alt=""></div>
      </div>
    </div>
  </div>
</div>
...
<div id="footer">
  <div class="container text-center">
    <div class="col-md-6">
      <p>&copy; 2023 Eventos Lucy - Proyecto de Luis Tapia Ig.. Todos los derechos reservados.</p>
    </div>
    <div class="col-md-6">
      <div class="social">
        <ul>
...
<script type="text/javascript" src="./admin/js/jqBootstrapValidation.js"></script> 
<script type="text/javascript" src="./admin/js/contact_me.js"></script> 
